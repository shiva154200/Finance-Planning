...
|---------|-------|--------------|
| `frontend/` | React 19, Vite, Tailwind CSS, Recharts | 5173 |
| `backend/` | Node.js, Express, Mongoose, JWT | 5000 |
| `ml-service/` | Python, FastAPI, Pandas | 8000 |
...
└── financenodejs/      # Legacy prototype (optional)
```
...
3. Backend sends profile data to the ML service
4. ML service returns two plans with allocations and projections
5. Gemini AI adds a readable analysis layer
6. Dashboard displays plans, charts, and recommendations
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | `/api/profile` | Save customer profile (protected) |

### Plans

| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | `/api/plans` | Generate financial plan (protected) |
...
4. **Plan generation** — produces Balanced and Growth plans with expected return, volatility, and required monthly investment
...
| File | Description |
|------|-------------|
| `ml-service/datasets/historical_data.csv` | Historical returns, volatility, and macro indicators |
| `ml-service/datasets/customer_financial_profiles.csv` | Sample customer profiles for development |
